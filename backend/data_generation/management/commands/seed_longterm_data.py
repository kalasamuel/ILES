"""
Django management command to seed ILES database with realistic long-term data.

Usage: python manage.py seed_longterm_data
"""
...
class Command(BaseCommand):
    help = 'Seed ILES database with realistic long-term data for testing'

    def handle(self, *args, **options):
        print("\n🚀 ILES REALISTIC LONG-TERM DATA SEEDER 🚀")
        print("=" * 70)
        ...
        try:
            ...
            # 1. Setup Roles
            # ============================================================================
            self.stdout.write("1️⃣ Setting up Roles...")
            roles_data = [
                {'role_name': 'Admin'},
                {'role_name': 'Student'},
            ...
            # 2. Setup Departments
            # ============================================================================
            self.stdout.write("2️⃣ Setting up Departments...")
            departments_data = [
            ...
            # ============================================================================
            self.stdout.write("3️⃣ Creating Academic Supervisors...")
            supervisors_data = [
                {
            ...
            # ============================================================================
            self.stdout.write("4️⃣ Creating Multiple Students...")
            ...
            for student_data in students_data:
                ...
                student, _ = Student.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        'expected_graduation': timezone.now() + timedelta(days=365*(4-student_data['year'])),
                    }
                )
            ...
            # ============================================================================
            self.stdout.write("5️⃣ Creating Multiple Organizations...")
            ...
            # ============================================================================
            self.stdout.write("6️⃣ Creating Workplace Supervisors...")
            ...
            # ============================================================================
            self.stdout.write("7️⃣ Creating Multiple Internship Placements...")
            ...
            # ============================================================================
            self.stdout.write("8️⃣ Creating Weekly Logs...")
            ...
            # ============================================================================
            self.stdout.write("9️⃣ Creating Evaluations...")
            ...
            # ============================================================================
            self.stdout.write("🔟 Creating Score Breakdowns...")
            ...
            # ============================================================================
            self.stdout.write("1️⃣1️⃣ Creating Log Reviews...")
                    ...
                    for log in weekly_logs[:8]:  # Review first 8 weeks
                        review, created = LogReview.objects.get_or_create(
                            ...
                            defaults={
                                ...
                                'reviewed_at': log.submitted_at + timedelta(days=random.randint(1, 5)) if log.submitted_at else timezone.now(),
                            }
                        )
                        if created:
                            reviews_created += 1
