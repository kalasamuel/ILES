...
function getSidebarItems(role) {
  const items = {
    [ROLES.STUDENT]: [
      ...
      { path: '/app/settings',   label: 'Settings',    Icon: Icons.Settings },
    ],
    ...
    [ROLES.ADMIN]: [
      ...
      { path: '/app/departments',   label: 'Departments',     Icon: Icons.GraduationCap },
      ...
      { path: '/app/deadlines',     label: 'Deadlines',       Icon: Icons.FileText },
